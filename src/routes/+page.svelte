...
<main class="flex flex-col items-center text-center">
  ...
  <ul class="flex flex-col items-center p-2">
    ...
    <li class="text-green-800 m-2">
      <a
        href="https://www.amazon.com/wedding/share/rachelizac"
        on:click={() => {
          notify("Someone clicked the Amazon Registry link");
        }}>Amazon Registry</a
      >
    </li>
    <li class="text-green-800 m-2">
      <a
        href="https://www.google.com/maps/place/50+W+500+N,+Lehi,+UT+84043/@40.3939417,-111.8528229,17z/data=!3m1!4b1!4m5!3m4!1s0x874d802ca4b10763:0xcd3c5c7f3b48a412!8m2!3d40.3939376!4d-111.850248?entry=ttu"
        on:click={() => {
          notify("Someone clicked the Google Maps link");
        }}>Reception Location</a
      >
    </li>
    <li class="text-green-800 m-2">
      <a
        href="https://account.venmo.com/u/Izac-Peterson"
        on:click={() => {
          notify("Someone clicked the Venmo link");
        }}>Venmo</a
      >
    </li>
  </ul>
